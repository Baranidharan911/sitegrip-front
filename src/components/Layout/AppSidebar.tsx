...
const AppSidebar = memo(() => {
    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700">
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
        <Link href="/dashboard" className="flex items-center space-x-2" onClick={handleClose}>
          ...
          <span className="text-xl font-bold text-gray-900 dark:text-white">SiteGrip</span>
        </Link>
        <button
  ...
  ), [memoizedSidebarItems, isActive, handleClose, toggleSidebar]);
...
const SidebarSection = memo(({ 
  ...
  ), [section, isActive, isExpanded, toggleExpanded, onItemClick]);
